 ...
 * never actually change the data held in them. In that case it's more appropriate to  *remove* the methods to set the fields.
 */

public class Card9a {
	
	//These never change once created so make them final
	...
	public Card9a(String cardName, String cardSuite) {
